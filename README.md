...
### Core & Interface
*   **Microcontroller:** STM 32 Microconroler (STM32F103C8T6)[cite: 1].
*   **Programming/Debugging:** Manual BOOT0 and NRST switches integrated for easy flashing.
*   **Storage:** MicroSD Card interface (47219-2001)[cite: 1] for offline environmental data logging.
...
*   **Temp/Humidity Sensor:** SHT3x-DIS[cite: 1].
*   **Air Quality Sensor:** ENS160-BGLM[cite: 1] (measures eCO2 and TVOCs).
*   **Light sensor:** OPT3001DNPRQ1[cite: 1] (for precise ambient light measurement).

### Power Management & Battery Protection
*   **USB & ESD:** USB-C receptacle protected by a TVS DIODE ARRAY for USB (D3V3XA4B10LP)[cite: 1].
*   **Voltage Regulation:** Onboard LDO Power 3.3V (AP2112K-3.3TRG1)[cite: 1].
*   **Battery Charging:** Integrated Li-Ion Battery Charger (MCP73831/2)[cite: 1].
*   **Battery Protection:** Dedicated IC (AP9101C)[cite: 1] paired with Dual N-Channel Mosfets (EFC2J013NUZ)[cite: 1] to prevent over-charge/discharge.
*   **Load Sharing:** A power-path circuit utilizing a P-Channel MOSFET (AO3401A)[cite: 1] and a Schottky diode (SS14)[cite: 1] allows the system to switch seamlessly between USB power and battery power without dropping voltage.
...
All necessary files to manufacture this board are located in the `/manufacturing` directory. The total BOM cost for the primary integrated circuits and connectors is approximately 19.97 € per board[cite: 1]. Ensure that your PCB manufacturer follows standard 2-layer or 4-layer stackups as defined in the KiCad design rules.
