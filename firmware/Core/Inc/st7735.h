...
#define ST7735_RES_Pin       Display_RES_Pin // NOTE: Check if you wired a reset pin! If not, you may need to software reset.
#define ST7735_RES_GPIO_Port Display_RES_GPIO_Port     // Update these to match your schematic.
#define ST7735_CS_Pin        SPI_CS1_Pin
#define ST7735_CS_GPIO_Port  SPI_CS1_GPIO_Port
